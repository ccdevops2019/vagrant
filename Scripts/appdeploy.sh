...
chown vagrant:vagrant spring-petclinic-2.1.0.BUILD-SNAPSHOT.jar
nohup java -jar /vagrant/spring-petclinic-2.1.0.BUILD-SNAPSHOT.jar -Dspring.profiles.active=mysql  > /dev/null 2>&1 & 